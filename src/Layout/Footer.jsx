...
const Footer = () => {
  return (
    <footer className="bg-[#f3f3f3cf] py-8 px-10 font-[sans-serif]">
          ...
          <li className="space-x-4">
            <a href="#">
              <svg
                ...
                fill="none"
                className="fill-blue-500 inline w-6 h-6"
                viewBox="0 0 24 24"
              >
                <path
                  fillRule="evenodd"
      ...
      <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-16">
